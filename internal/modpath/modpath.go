// Package modpath provides utilities for parsing and constructing Go module paths,
// specifically for handling major-version suffixes (e.g. /v2, .v2).
package modpath
...
// ParseModulePath splits a module path into its base path, current major version
// number, and separator string.
//
// Examples:
//
...
// NextMajorPath builds the module path for the given major version, using the
// provided separator.
